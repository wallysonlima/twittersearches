...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // user a LinearLayoutManager to display items in a vertical list
    ...
    // hide/show saveFloatingActionButton based on EditText's contents
    ...
    private final View.OnClickListener saveButtonListener =
            new View.OnClickListener() {
                // add/update search if niether query nor tag is empty
                @Override
